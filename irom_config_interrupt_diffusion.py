...
class wm_args:
    ########################### training args ##############################
    # model paths
    pretrained_model_path = "/n/fs/ug-ctrl-wrld/ctrl_world/svd"
    clip_model_path ="/n/fs/ug-ctrl-wrld/ctrl_world/clip"
    ckpt_path = '/n/fs/ug-ctrl-wrld/ctrl_world/checkpoints/checkpoint-10000.pt'
    pi_ckpt = '/n/fs/ug-ctrl-wrld/ctrl_world/openpi/checkpoints/openpi-assets/checkpoints/pi05_droid'

    # dataset parameters
    # raw data
    dataset_root_path = "/n/fs/ug-ctrl-wrld/ctrl_world/initial_rw_data"
    ...
    save_root_path = "/n/fs/ug-ctrl-wrld/ctrl_world/interrupt_diffusion" 
