...
if __name__ == "__main__":
    ...
    for val_id_i, start_idx_i in zip(args.val_id, args.start_idx):
        ...
        for trial in range(10):
            ...
            filename_video = f"{args.save_dir}/{args.task_name}/trial{trial}/video/time_{uuid}_traj_{val_id_i}_{start_idx_i}_{args.policy_skip_step}_{text_id}.mp4"
            ...
            # save to json
            filename_info = f"{args.save_dir}/{args.task_name}/trial{trial}/info/time_{uuid}_traj_{val_id_i}_{start_idx_i}_{pred_step}_{text_id}.json"
