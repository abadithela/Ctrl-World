...
class wm_args:
    ...
    pretrained_model_path = f"{PROJECT_ROOT}/checkpoints/stable-video-diffusion-img2vid"
    clip_model_path = f"{PROJECT_ROOT}/checkpoints/clip-vit-base-patch32"
    ckpt_path = f"{PROJECT_ROOT}/checkpoints/wm/checkpoint-10000.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--clip_model_path', type=str, default=f"{PROJECT_ROOT}/checkpoints/clip-vit-base-patch32")
    parser.add_argument('--ckpt_path', type=str, default=f"{PROJECT_ROOT}/checkpoints/wm/checkpoint-10000.pt")
    parser.add_argument('--svd_model_path', type=str, default=f"{PROJECT_ROOT}/checkpoints/stable-video-diffusion-img2vid")
    ...
    for env_dir in env_dirs:
        ...
        for trial_idx in range(num_trials):
            ...
            filename_video = f"{args.save_dir}/{args.task_name}/video/time_{uuid}_{env_name}_trial{trial_idx}_{args.policy_skip_step}_{text_id}.mp4"
            ...
            filename_info = f"{args.save_dir}/{args.task_name}/info/time_{uuid}_{env_name}_trial{trial_idx}_{pred_step}_{text_id}.json"
